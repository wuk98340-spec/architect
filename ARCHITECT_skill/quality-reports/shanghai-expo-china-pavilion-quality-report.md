...
| --- | ---: | --- | --- |
| `shanghai-expo-china-pavilion` | 94.5 | A benchmark-level | Read the text as an argument: project problem -> design method -> spatial/built result -> transferable lesson.; For each strategy, judge whether it follows problem -> method -> architectural effect -> evidence -> transferable lesson. |
