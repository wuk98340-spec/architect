...
```powershell
python ARCHITECT_skill/scripts/review_case_quality.py --benchmarks --output ARCHITECT_skill/quality-reports/benchmark-quality-report.md
python ARCHITECT_skill/scripts/review_case_quality.py case-packages/<slug>
python ARCHITECT_skill/scripts/review_case_quality.py --output ARCHITECT_skill/quality-reports/all-case-quality-report.md
```
