...
![苏州博物馆新馆的三路布局、平面与剖面关系](images/03_plan_and_section_crop.jpg)
...
![传统民居与园林语汇的几何化、现代化转译](images/07_spatial_language_crop.jpg)
...
![庭院、采光、屋面与石材构造的组合表达](images/01_hero_courtyard_and_materials.jpg)
...
| --- | --- | --- | --- | --- | --- | --- |
| 03_plan | 平面 / 剖面 / 布局分析 | 已嵌入：`images/03_plan_and_section_crop.jpg` | 用户提供 PDF《贝聿铭作品.pdf》第 6 页 | downloaded | 用于说明三路布局、院落组织、局部高度和剖面关系 | 课堂研究整理；权利未清除 |
| 07_concept | 空间语言 / 传统转译分析 | 已嵌入：`images/07_spatial_language_crop.jpg` | 用户提供 PDF《贝聿铭作品.pdf》第 7 页 | downloaded | 用于说明传统民居、园林语汇的抽象化与现代化 | 课堂研究整理；权利未清除 |
| 01_hero | 建成空间 / 材料构造分析 | 已嵌入：`images/01_hero_courtyard_and_materials.jpg` | 用户提供 PDF《贝聿铭作品.pdf》第 8 页 | downloaded | 用于说明庭院、墙面、屋面、玻璃和石材的组合表达 | 课堂研究整理；权利未清除 |
